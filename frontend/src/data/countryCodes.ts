// ITU-assigned calling codes (E.164 country codes) - standard public data,
// not something that changes per-project. Sorted alphabetically by country
// name; Spain is first since this project's primary user is Spain-based,
// so it's a sane default in the picker without needing geolocation.
